...
> [!summary] 案例定位
> 这是一个把 **曲线运动学、固定弦长链、刚体碰撞、临界参数搜索、分段路径和连续极值** 串成完整证据链的综合案例。这里保存可迁移的关系与复习入口；完整推导、结果、代码和论文仍以 [[06-Projects/2024国赛A题-板凳龙/Readme|板凳龙项目主页]] 为唯一事实源，避免在 Research 中复制整篇项目。
