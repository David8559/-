...
TOPICS = [
    ...
    ("topic/动态规划", "动态规划 Hub", ["动态规划", "多阶段决策", "bellman"]),
    ("topic/马尔可夫决策", "马尔可夫决策过程 Hub", ["马尔可夫决策", "mdp", "状态转移概率", "动作价值"]),
    ("topic/博弈论", "博弈论 Hub", ["博弈", "纳什均衡", "支付矩阵", "混合策略", "占优策略"]),
    ("topic/蒙特卡洛", "蒙特卡洛 Hub", ["蒙特卡洛", "随机模拟", "抽样统计"]),
